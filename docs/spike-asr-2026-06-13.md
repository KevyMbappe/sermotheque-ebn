...
- **Speed caveat:** ~6–7× real-time ⇒ a 56-min sermon ≈ ~8 min compute ⇒ the 239 SC sermons ≈ **~30+ h local compute** (run over several nights / parallelize / cloud GPU; not one overnight).
