...
*Document de présentation · anciens & équipe média · 13 juin 2026*
...
- ✅ **Regroupement en séries** (22 séries ordonnées).
...
| Phase | Objectif | État |
|---|---|---|
| **1 — Fondation du catalogue** | Base de données unifiée et enrichie | **En cours** |
| **2 — Publication web** | Section « Prédications » sur le site : recherche par livre, série, prédicateur | À venir |
| **3 — Applications** | Mobile + TV : un lieu dédié pour écouter/regarder, sans la distraction de YouTube | Ultérieur |

**Détail Phase 1, à venir :** intégrer le contenu YouTube (conférences) au catalogue ; **enrichissement automatique** (transcriptions, sujets, résumés) par intelligence artificielle, **validé par un humain** ; puis publication sur le site.

## Ce dont nous avons besoin

- **Équipe média :** confirmer que l'audio SoundCloud ne contient **que la prédication** (sans la liturgie) ; préciser le **prédicateur « par défaut »** (souvent absent des titres).
