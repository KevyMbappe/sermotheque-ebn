...
**only the numbered Scripture text is imported**, including poetry continuations.
No introductions, section headings, cross-reference notes or Strong's metadata are included.
Typography and wording are retained; whitespace is collapsed when joining verse lines.
